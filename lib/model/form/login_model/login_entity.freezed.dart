...
abstract class $LoginEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({Field email, Field password, bool buttonState});
...
class _$_LoginEntity extends _LoginEntity {
  const _$_LoginEntity(
      {required this.email, required this.password, required this.buttonState})
      : super._();
  ...
  @override
  String toString() {
    return 'LoginEntity(email: $email, password: $password, buttonState: $buttonState)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, email, password, buttonState);
...
abstract class _LoginEntity extends LoginEntity {
  const factory _LoginEntity(
      ...
      required final bool buttonState}) = _$_LoginEntity;
